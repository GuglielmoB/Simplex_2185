...
namespace Simplex
{
	class Player :
		public MyRigidBody
	{
	typedef MyRigidBody* PlayerRigidBody; //Entity Pointer
	...
	PlayerRigidBody* m_CollidingArray = nullptr; //array of rigid bodies this one is colliding with
...
public:
	...
	*/
	//Player(std::vector<vector3> a_pointList);
	/*
